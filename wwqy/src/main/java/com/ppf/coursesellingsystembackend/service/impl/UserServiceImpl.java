...
import com.ppf.coursesellingsystembackend.mapper.UserMapper;
import com.ppf.coursesellingsystembackend.model.dto.user.UserQueryRequest;
...
import static com.ppf.coursesellingsystembackend.constant.UserConstant.USER_LOGIN_STATE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User>
    ...
    public QueryWrapper<User> getQueryWrapper(UserQueryRequest userQueryRequest) {
        ...
        List<String> courseList = userQueryRequest.getCourseList();
        String sortField = userQueryRequest.getSortField();
        String sortOrder = userQueryRequest.getSortOrder();
        QueryWrapper<User> queryWrapper = new QueryWrapper<>();
        if (CollectionUtils.isNotEmpty(courseList)) {
            for (String course : courseList) {
                queryWrapper.like("courseList", "\"" + course + "\"");
            }
        }
